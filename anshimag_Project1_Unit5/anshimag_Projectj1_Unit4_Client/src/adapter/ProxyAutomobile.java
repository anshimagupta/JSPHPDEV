 ...
 * This abstract class implements all the methods declared in the interfaces
 */
...
public abstract class ProxyAutomobile implements Serializable {
    ...
    /**
     * Adds the new model accepted from the client to the Hash Map
     * @param modelName
     * @param automobile
     */
    public void addCarModelOptions(String modelName, Automobile automobile) {
        automobiles.put(modelName, automobile);
    }

    public String listAllModelNames() {
        StringBuilder stringBuilder = new StringBuilder();
        for (String s : automobiles.keySet()) {
    ...
    /**
     * Returns the entire automobile Object
     */
